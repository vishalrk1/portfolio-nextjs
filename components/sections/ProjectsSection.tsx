...
const ProjectsSection = () => {
  return (
    <motion.section
      ...
      className="flex flex-col justify-center bg-secondary w-full px-6 lg:px-60 py-8"
    >
      ...
      <div className="flex flex-wrap justify-between lg:justify-evenly gap-4 mt-6">
